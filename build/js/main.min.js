...
/* harmony import */ var _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/select/custom-select */ "./js/modules/select/custom-select.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var select = new _modules_select_custom_select__WEBPACK_IMPORTED_MODULE_1__["CustomSelect"]();
  select.init();
...
/* harmony import */ var _tabs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs.js */ "./js/modules/tabs/tabs.js");

var tabs;
var initTabs = function initTabs() {
  var parent = document.querySelector('.tabs--cards'); // родитель
  var elements = parent.querySelectorAll('.card-element'); // карточки
  ...
  var handleResize = function handleResize() {
    if (breakpoint.matches) {
      ...
      elements.forEach(function (el) {
        return el.setAttribute('data-tabs', 'element');
      });
      if (!tabs) {
        tabs = new _tabs_js__WEBPACK_IMPORTED_MODULE_0__["Tabs"]();
        window.tabs = tabs;
      } else {
        tabs.reInit();
      }
      ...
      elements.forEach(function (el) {
        return el.removeAttribute('data-tabs');
      });

      // сброс высоты и активных классов
      var content = parent.querySelector('[data-tabs="content"]');
      if (content) content.style.height = null;
      elements.forEach(function (el) {
        return el.classList.remove('is-active');
      });
      var controls = parent.querySelectorAll('[data-tabs="control"]');
      controls.forEach(function (ctrl) {
        return ctrl.classList.remove('is-active');
      });
    }
  };
